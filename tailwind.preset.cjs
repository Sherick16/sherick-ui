...
const DARK = {
  ...
  "surface-overlay": "0.295 0.014 260",
  ink: "0.94 0.008 255",
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "sherick-glass-hero":
          "var(--sui-glass-hero-gradient, linear-gradient(180deg, rgba(255,255,255,0.035) 0%, rgba(255,255,255,0.012) 12%, rgba(255,255,255,0) 44%, rgba(0,0,0,0.14) 100%))",
      },
